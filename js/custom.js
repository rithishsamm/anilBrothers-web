...
//   }
  ...
  const images = [
    ...
    {
        src: 'images/products/Lifting tools and machines/Manual Hydraulic Lift.png',
        title: 'Manual Hydraulic Lift',
        Price: '₹40,000/Unit',
        details: {
    ...
    {
        src: 'images/products/Lifting tools and machines/Scissor Table Hydraulic Lift.png',
        title: 'Scissor Table Hydraulic Lift',
        Price: '₹2,99,999/Unit',
        details: {
    ...
    {
        src: 'images/products/Lifting tools and machines/Manual Pallet Stacker.png',
        title: 'Manual Pallet Stacker',
        Price: '₹60,000/Unit',
        details: {
            "Usage/Application": "Industrial",
    ...
    {
        src: "images/products/Storage and Placers/Mild Steel Storage Containers.png",
        title: "Mild Steel Storage Containers",
        details: {
            Material: "Mild Steel",
            Color: "Blue",
            "No Of Container": 6,
    ...
    {
        src: "images/products/Storage and Placers/Stainless Steel Water Tank.png",
    ...
    {
        src: "images/products/Conveyor systems/Inspection Conveyor Machine.png",
        title: "Inspection Conveyor Machine",
        details: {
            Material: "Stainless Steel",
            Voltage: "220 - 240 V",
    ...
    {
        src: "images/products/Conveyor systems/SS Packing Belt Conveyor.png",
        title: "Stainless Steel Packing Belt Conveyor",
        details: {
            Material: "Stainless Steel",
            "Belt Material": "PU",
            Voltage: "240 V",
    ...
    {
        src: "images/products/Conveyor systems/Table Packing Belt Conveyor.png",
        title: "Table Packing Belt Conveyor",
        details: {
            Type: "Belt",
    ...
    {
        src: "images/products/Pick and place systems/Pick And Place Unit.png",
        title: "Pick And Place Unit",
        details: {
    ...
    {
        src: "images/products/Other tools and services/Mild Steel Oil Skimmer.png",
    ...
    {
        src: "images/products/Other tools and services/Heavy Duty Trolley Jack.png",
        title: "Heavy Duty Trolley Jack",
        details: {
    ...
    {
        src: "images/products/Skimmers/Mild Steel Fabrication Service.png",
        title: "Mild Steel Fabrication Service",
        details: {
            "Type Of Structure": "Beam, Cables & Arches, Plates & Slabs, Column, Grid",
            Industry: "Commercial",
